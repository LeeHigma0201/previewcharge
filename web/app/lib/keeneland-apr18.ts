...
export interface StaticRace {
  ...
  trackBias: TrackBias;
  horses: StaticHorse[];
  scratches?: string[];     // program numbers scratched day-of
}
...
const race2: StaticRace = {
  ...
  scratches: ["1", "6"], // D Day Sky, Phraseologism (from official chart)
  trackBias: {
...
const race3: StaticRace = {
  ...
  scratches: ["11", "14", "15", "16"], // Pillar of Beauty, JZ's Last Schance, Trust Fund Philly, Family
  trackBias: {
  ...
  horses: [
    ...
    h("3",  "Glean",             15.0, "EP", [77, 77, 96], 336, 126, { primePower: 112.1, currentClass: 0,     avgClassLast3: 113.0, earlyPaceLast: 98,  latePaceLast: 77, mudPct: 11 }),
    h("11", "Pillar of Beauty",   6.0, "EP", [83, 84, 94],  43, 126, { primePower: 122.7, currentClass: 112.7, avgClassLast3: 113.0, earlyPaceLast: 93,  latePaceLast: 86, mudPct: 17 }),
    h("12", "Stepping Stones",    4.5, "EP", [80, 83, 82],  36, 126, { primePower: 124.9, currentClass: 112.7, avgClassLast3: 112.5, earlyPaceLast: 92,  latePaceLast: 81, mudPct: 19 }),
    ...
    h("4",  "Betty's Dance",     10.0, "P",  [79, 79, 99],  43, 126, { primePower: 122.7, currentClass: 112.4, avgClassLast3: 113.0, earlyPaceLast: 89,  latePaceLast: 72 }),
    h("13", "Something Stronger",10.0, "EP", [81, 83, 91],  70, 126, { primePower: 119.1, currentClass: 111.1, avgClassLast3: 111.4, earlyPaceLast: 89,  latePaceLast: 81, mudPct: 18 }),
    h("6",  "Valala",            20.0, "E",  [78, 78, 80],  24, 126, { primePower: 111.4, currentClass: 0,     avgClassLast3: 112.6, earlyPaceLast: 85,  latePaceLast: 80 }),
    h("5",  "Miss Lonelle",      20.0, "P",  [70, 70, 85],  38, 126, { primePower: 109.3, currentClass: 110.2, avgClassLast3: 111.0, earlyPaceLast: 0,   latePaceLast: 70 }),
    ...
    h("16", "Family",            12.0, "EP", [72, 72, 83],  38, 126, { primePower: 111.4, currentClass: 0,     avgClassLast3: 111.4, earlyPaceLast: 82,  latePaceLast: 72 }),
...
const race4: StaticRace = {
  ...
  scratches: ["4", "9"], // Baytown Bruiser + Truly Legit scratched day-of
  trackBias: {
    surface: "Dirt", distanceLabel: "8.5f",
    speedBiasPct: 86, railBias: "0",
    eIV: 1.58, epIV: 1.63, pIV: 0.00, sIV: 0.64,
  ...
  horses: [
    ...
    h("9", "Truly Legit",        15.0, "P",  [72, 78, 74],  30, 127, { primePower: 118.8, currentClass: 112.6, avgClassLast3: 111.7, earlyPaceLast: 72,  latePaceLast: 81, mudPct: 15 }),
...
const race5: StaticRace = {
  ...
  scratches: ["1", "3", "6"], // Money Man, Good Willie, Susan's Boy (official chart)
  trackBias: {
    surface: "Dirt", distanceLabel: "8.5f",
    speedBiasPct: 86, railBias: "0",
    eIV: 1.58, epIV: 1.63, pIV: 0.00, sIV: 0.64,
  ...
  horses: [
    h("6",  "Susan's Boy",      4.0, "P",  [83, 88, 83],  59, 118, { primePower: 123.8, currentClass: 111.9, avgClassLast3: 111.4, earlyPaceLast: 93, latePaceLast: 88, mudPct: 20 }),
    ...
    h("10", "Street Party",     5.0, "E",  [81, 81, 83],  60, 118, { primePower: 118.0, currentClass: 109.6, avgClassLast3: 110.1, earlyPaceLast: 87, latePaceLast: 81, mudPct: 17 }),
    h("1",  "Money Man",        8.0, "P",  [76, 84, 89],  87, 118, { primePower: 116.8, currentClass: 0,     avgClassLast3: 110.0, earlyPaceLast: 80, latePaceLast: 78, mudPct: 16 }),
    ...
    h("4",  "Blue Mountains",   8.0, "E",  [66, 69, 72],  38, 118, { primePower: 115.9, currentClass: 0,     avgClassLast3: 110.1, earlyPaceLast: 86, latePaceLast: 66, mudPct: 16 }),
    h("2",  "Dare Defying",    12.0, "P",  [62, 0,  72],  15, 118, { primePower: 110.8, currentClass: 106.5, avgClassLast3: 109.8, earlyPaceLast: 80, latePaceLast: 65 }),
    ...
    h("3",  "Good Willie",     10.0, "P",  [0,  0,  0],   0,   118, { primePower: 109.9, currentClass: 0,     avgClassLast3: 107.9, earlyPaceLast: 82, latePaceLast: 66 }),
    h("8",  "Syntagma",        15.0, "P",  [68, 0,  0],   65, 118, { primePower: 102.0, currentClass: 0,     avgClassLast3: 106.9, earlyPaceLast: 70, latePaceLast: 65 }),
...
const race6: StaticRace = {
  ...
  horses: [
    ...
    h("8",  "Candy Rockette",  4.5, "P",  [81, 79, 71],  48, 122, { primePower: 132.2, currentClass: 0,     avgClassLast3: 113.2, earlyPaceLast: 83, latePaceLast: 84, mudPct: 16 }),
    h("9",  "Kentucky Belle",  1.6, "S",  [79, 65, 89],  42, 122, { primePower: 129.2, currentClass: 112.7, avgClassLast3: 111.5, earlyPaceLast: 73, latePaceLast: 82 }),
    ...
    h("3",  "Bless Her",       6.0, "P",  [84, 79, 85],  28, 122, { primePower: 126.6, currentClass: 110.5, avgClassLast3: 113.2, earlyPaceLast: 83, latePaceLast: 86, mudPct: 17 }),
...
const race7: StaticRace = {
  ...
  scratches: ["5", "6"], // Politicallycorrect, Modus Bestia (official chart)
  trackBias: {
...
const race9: StaticRace = {
  ...
  scratches: ["9"], // Honor Marie SCR per TwinSpires live
  trackBias: {
  ...
  horses: [
    // R9 programs from official Brisnet PPs (research synth — PP = actual program)
    h("1", "Stars and Stripes",  1.6, "EP", [100, 88, 104], 41, 123, { primePower: 139.5, currentClass: 119.3, avgClassLast3: 119.6, earlyPaceLast: 93,  latePaceLast: 95, mudPct: 11 }),
    h("2", "Awesome Aaron",     15.0, "P",  [98, 98, 78],   21, 101, { primePower: 141.2, currentClass: 120.5, avgClassLast3: 119.7, earlyPaceLast: 95,  latePaceLast: 88, mudPct: 17 }),
    h("3", "Tennessee Lamb",    12.0, "P",  [82, 91, 90],   21, 113, { primePower: 127.1, currentClass: 0,     avgClassLast3: 115.8, earlyPaceLast: 41,  latePaceLast: 74, mudPct: 19 }),
    h("4", "British Isles",      4.5, "EP", [94, 99, 92],   42, 123, { primePower: 148.0, currentClass: 122.0, avgClassLast3: 120.5, earlyPaceLast: 89,  latePaceLast: 98, mudPct: 8, isClassDrop: true }),
    h("5", "San Siro",           8.0, "P",  [89, 98, 85],   28, 118, { primePower: 118.3, currentClass: 0,     avgClassLast3: 118.0, earlyPaceLast: 81,  latePaceLast: 87, mudPct: 12 }),
    h("6", "Batten Down",        4.0, "E",  [82, 98, 88],   48, 104, { primePower: 134.7, currentClass: 0,     avgClassLast3: 115.8, earlyPaceLast: 81,  latePaceLast: 75, mudPct: 17 }),
    h("7", "Guns and Glory",    50.0, "P",  [0, 0, 65],     21, 89,  { primePower: 122.2, currentClass: 0,     avgClassLast3: 112.5, earlyPaceLast: 0,   latePaceLast: 0, mudPct: 20 }),
    h("8", "Rattle N Roll",      3.0, "S",  [72, 97, 100], 63, 126, { primePower: 128.0, currentClass: 121.2, avgClassLast3: 115.0, earlyPaceLast: 72, latePaceLast: 85, mudPct: 7 }),
    h("9", "Honor Marie",       10.0, "P",  [92, 89, 80],   28, 111, { primePower: 138.8, currentClass: 117.7, avgClassLast3: 119.0, earlyPaceLast: 83,  latePaceLast: 96, mudPct: 16 }),
  ],
};
...
const race10: StaticRace = {
  ...
  scratches: ["13"], // Dancin in Da'nile SCR per TwinSpires live
  trackBias: {
    surface: "Turf", distanceLabel: "routes",
    speedBiasPct: 56, railBias: "+",
    eIV: 0.62, epIV: 2.21, pIV: 0.69, sIV: 0.71,
  ...
  horses: [
    // R10 programs from official BRIS PPs (research synth — PP = actual program)
    h("1",  "Padiddle",        15.0, "P",  [94, 94, 83],  49, 107, { primePower: 151.0, currentClass: 117.7, avgClassLast3: 117.5, earlyPaceLast: 81,  latePaceLast: 86, mudPct: 10 }),
    h("2",  "Desvio",           8.0, "S",  [73, 73, 92],  167, 113, { primePower: 142.9, currentClass: 0,     avgClassLast3: 116.3, earlyPaceLast: 58,  latePaceLast: 60 }),
    h("3",  "Utah Beach",       8.0, "S",  [73, 101, 92],  28, 89,  { primePower: 153.0, currentClass: 118.4, avgClassLast3: 118.0, earlyPaceLast: 87,  latePaceLast: 85, mudPct: 10 }),
    h("4",  "Grand Sonata",     6.0, "S",  [96, 98, 89],   49, 109, { primePower: 151.6, currentClass: 118.1, avgClassLast3: 118.4, earlyPaceLast: 87,  latePaceLast: 88, mudPct: 10 }),
    h("5",  "Fleetfoot",       12.0, "S",  [82, 82, 78], 167, 116, { primePower: 116.6, currentClass: 0,     avgClassLast3: 116.6, earlyPaceLast: 0,   latePaceLast: 72 }),
    h("6",  "Burnham Square",   4.0, "P",  [84, 84, 73],  49, 105, { primePower: 154.8, currentClass: 115.3, avgClassLast3: 118.6, earlyPaceLast: 84,  latePaceLast: 98, mudPct: 15 }),
    h("7",  "Truly Quality",    5.0, "S",  [99, 99, 87],  49, 99,  { primePower: 159.4, currentClass: 119.9, avgClassLast3: 120.2, earlyPaceLast: 99,  latePaceLast: 98 }),
    h("8",  "Tawny Port",       4.5, "S",  [99, 99, 99], 168, 132, { primePower: 160.3, currentClass: 119.9, avgClassLast3: 120.2, earlyPaceLast: 99,  latePaceLast: 98, mudPct: 15 }),
    h("9",  "Navy Seal",       15.0, "P",  [98, 101, 94], 167, 141, { primePower: 159.4, currentClass: 119.4, avgClassLast3: 119.5, earlyPaceLast: 97,  latePaceLast: 94, mudPct: 18 }),
    h("10", "Presider",        20.0, "S",  [92, 90, 80],  56, 113, { primePower: 151.6, currentClass: 115.5, avgClassLast3: 118.4, earlyPaceLast: 81,  latePaceLast: 85, mudPct: 12 }),
    h("11", "Freedom's Way",   20.0, "S",  [75, 75, 84], 269, 132, { primePower: 143.2, currentClass: 0,     avgClassLast3: 115.3, earlyPaceLast: 60,  latePaceLast: 77, mudPct: 11 }),
    h("12", "Anegada",         15.0, "EP", [94, 96, 100], 49, 108, { primePower: 151.0, currentClass: 118.0, avgClassLast3: 117.9, earlyPaceLast: 80,  latePaceLast: 86 }),
    h("13", "Dancin in Da'nile",10.0, "P",  [97, 97, 104], 49, 141, { primePower: 154.8, currentClass: 118.7, avgClassLast3: 118.6, earlyPaceLast: 89,  latePaceLast: 94, mudPct: 15 }),
  ],
};
...
const race11: StaticRace = {
  ...
  scratches: ["1", "6"], // Thesewallshaveears, Army's Marauder SCR per TwinSpires live
  trackBias: {
  ...
  horses: [
    ...
    h("12", "Full Dolly",           15.0, "S",  [67, 67, 0],  100, 120, { primePower: 108.8, currentClass: 0,     avgClassLast3: 110.8, earlyPaceLast: 77,  latePaceLast: 80, mudPct: 15 }),
